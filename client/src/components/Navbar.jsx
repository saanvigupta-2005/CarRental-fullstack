...
const Navbar = ({}) => {
  ...
  return (
    ...
    >
      <Link to="/">
        <motion.img whileHover={{scale: 1.05}} src={assets.logo} alt="Logo" className="w-32 md:w-40 h-auto object-contain"/>
      </Link>
      ...
      >
        ...
        <div className='hidden lg:flex items-center gap-2 border border-borderColor
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          ...
          <button
            ...
            className='cursor-pointer px-8 py-2 bg-blue-600 hover:bg-blue-700 transition-all text-white rounded-lg'
          >
            {user ? 'Logout' : 'Login'}
          </button>
        </div>
